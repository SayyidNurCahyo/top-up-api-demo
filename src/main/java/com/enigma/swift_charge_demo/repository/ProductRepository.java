...
public interface ProductRepository extends JpaRepository<Product,String> {
    ...
    @Query(value = "SELECT * FROM m_product WHERE product_price = :price AND availability = true", nativeQuery = true)
    Optional<Page<Product>> findByNameOrPrice(@Param("price") Long price, Pageable pageable);
